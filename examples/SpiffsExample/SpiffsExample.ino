...
void setup()
{
    ...
    Logger.registerSpiffs(MAIN, ELOG_LEVEL_DEBUG, "main");
    Logger.registerSpiffs(SUB_COUNTER, ELOG_LEVEL_ERROR, "subcount"); // We only want to log errors
    Logger.registerSpiffs(HEX_LOG, ELOG_LEVEL_DEBUG, "hex");
